...
{
    return _useableTrackLength * (value - _minimumValue) / ( _maxmimumValue - _minimumValue) + (_knobWidth/2);
}
...
-(BOOL) continueTrackingWithTouch:(UITouch *)touch withEvent:(UIEvent *)event
{
    ...
    float valueDelta = (_maxmimumValue - _minimumValue) * delta / _useableTrackLength;
    ...
    if( _upperKnobLayer.highlighted){
        ...
        _upperValue = BOUND(_upperValue, _maxmimumValue, _minimumValue);
    }
